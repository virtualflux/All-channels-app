...
import {
  contactPersonSchema,
  customerSchema,
} from "@/app/api/db/customers/types/customer";
...
const CustomerForm = () => {
  const formik = useFormik<
    ...
    > & { contact_type: string; customer_sub_type: string }
  >({
    initialValues: {
          ...
          >
            ...
            <div className="col-span-full">
              ...
              <select
                ...
                className={`w-1/2 p-2 border rounded-lg focus:ring-1 focus:ring-teal-500 focus:border-teal-500 ${
                  formik.touched.customer_sub_type &&
                  formik.errors.customer_sub_type
                    ? "border-red-500"
                    : "border-gray-300"
                }`}
              >
