...
import { priceListSchema } from "@/app/api/db/pricelists/types/pricelist";
...
export const PriceListForm = () => {
  ...
  const formik = useFormik<FormState>({
    ...
    validationSchema: toFormikValidationSchema(priceListSchema),
    onSubmit: async (values, { setSubmitting, resetForm }) => {
      try {
        ...
        const payload: Omit<FormState, "is_increase"> & {
          is_increase?: boolean;
        } =
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
          <div className="mb-6">
            ...
            <p className="text-gray-600">
              Configure a sales or purchase price list (fixed percentage or
              per-item).
            </p>
          </div>
          ...
          >
            ...
            <div className="md:col-span-6">
              ...
              <SearchableDropdown
                ...
                onSelect={(opt) =>
                  formik.setFieldValue("sales_or_purchase_type", opt.value)
                }
                placeholder="Select type"
              />
              {formik.touched.sales_or_purchase_type &&
                formik.errors.sales_or_purchase_type && (
                  <div className="mt-1 text-sm text-red-600">
                    {formik.errors.sales_or_purchase_type as string}
                  </div>
                )}
            </div>
            ...
            <div className="md:col-span-6">
              ...
              <SearchableDropdown
                ...
                onSelect={(opt) =>
                  formik.setFieldValue("currency_id", opt.value)
                }
                placeholder="Select currency"
              />
              {formik.touched.currency_id && formik.errors.currency_id && (
                <div className="mt-1 text-sm text-red-600">
                  {formik.errors.currency_id as string}
                </div>
              )}
            </div>
            ...
            <div className="md:col-span-6">
              ...
              <SearchableDropdown
                ...
                onSelect={(opt) =>
                  formik.setFieldValue("rounding_type", opt.value)
                }
              ...
              <>
                <div className="md:col-span-6">
                  <RadioGroup
                    ...
                    defaultValue={formik.values.is_increase ?? ""}
                  >
                ...
                <div className="md:col-span-6 -mt-12">
                  ...
                  <input
                    ...
                    onBlur={formik.handleBlur}
                    className={`w-1/2 px-4 py-3 border rounded-lg focus:border-teal-500 ${
                      (formik.touched as any).percentage &&
                      (formik.errors as any).percentage
                        ? "border-red-500"
                        : "border-zinc-300"
                    }`}
                    placeholder="e.g., 10"
